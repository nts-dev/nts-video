...
<head>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/ace/1.3.3/ace.js?v=1" type="text/javascript"
            charset="utf-8"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/ace/1.2.6/ext-beautify.js?v=1" type="text/javascript"
            charset="utf-8"></script>
