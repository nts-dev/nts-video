...
open -a "Google Chrome" --args -allow-file-access-from-files /Library/WowzaStreamingEngine/examples/VideoOnDemandStreaming/MPEGDASHPlayer/player.html >& /dev/null &
