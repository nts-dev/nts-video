...
//                echo json_encode(array("state" => false, "message" => $value));
    ...
    case 4:
        ...
        $ROOT_PATH = "../../mediaresources/cuts/";

        $uploadFileDir = $ROOT_PATH . $name;
         ...
         *Configure file
         */
        $file->set_url($url . "mediaresources/cuts/" . $name . '/' . $FILE_ALIAS);
        $file->set_ext($fileExtension);
...
//        echo $parent_name; exit;
        ...
        $NEW_PATH = $uploadFileDir . "/" . $FILE_ALIAS;
        $FILE_URL = $url . "mediaresources/cuts/" . $folder_name . '/chunks/' . $FILE_ALIAS;
