...
//STORY EDITOR
    tinyMCE.init({
        ...
        "insertdatetime contextmenu paste emoticons colorpicker textpattern"
        ],
         toolbar1: "save | undo redo  | bold italic underline strikethrough | localautosave",
